...
+ annoByCpG  
This function annotate the integration site by CpG site data from UCSC genome database.  
User can get site information inserted within CpG sites and distribution from CpG coordinations.  
Plus, user can do random distribution analysis by this function.  

1. With random integration site analysis
    ``` {R results='hide', message=FALSE}
    gc(reset = TRUE)
    blast_cpg_10K=annoByCpG(hits=blast_obj, 
                            organism='GRCh37',  
                            interval=5000, 
                            range=c(-20000, 20000),  
                            doRandom=TRUE, 
...
**[ Integration site distribution from CpG site ]**  
``` {R echo=FALSE}
    knitr::include_graphics('A5_15856M_BLAST_10K_distribution_CpG_GRCh37.png')
```
    
2. Without random integration site analysis
    ``` {R results='hide', message=FALSE}
    blast_cpg_norandom=annoByCpG(hits=blast_obj, 
                                 organism='GRCh37',  
                                 interval=5000, 
                                 range=c(-20000, 20000),  
                                 doRandom=FALSE,  
...
**[ Integration site distribution from CpG site ]**  
``` {R echo=FALSE}
    knitr::include_graphics('A5_15856M_BLAST_norandom_distribution_CpG_GRCh37.png')
```
...
**[ Integration sites marked with CpGs ]**  
``` {R echo=FALSE}
    knitr::include_graphics('Ideogram_A5_15856M_BLAST_karyo_cpg_GRCh37_decided.png')
```
