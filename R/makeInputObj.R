...
#' User can use BLAST and BLAT output format specifically.
#' }
#'              
#' @usage 
...
#' 
#' @param inFile a string vector. Location of a local alignment result file. When you use BLAT result file (*.psl),
