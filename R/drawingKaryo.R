...
#' 
#' @param hits a GR object. This object made from \code{\link{makeExpSet}} function.
#' @param feature a GR object. This object made from annotation function. 
#' @param organism a character vector. This function serves 2 versions of organisms\cr
...
#' 
#' @export
drawingKaryo = function(hits, feature, organism = 'GRCh37', outPath = getwd(), outFileName = paste0('RIPAT', round(unclass(Sys.time())))){
