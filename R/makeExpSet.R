...
#' 
#' @param inFile a string vector. The path of a local alignment result file.\cr
...
#' 
#' @export
makeExpSet = function(inFile, mapTool = 'blast', vectorPos = 'front', outPath = getwd(), outFileName = paste0('RIPAT', round(unclass(Sys.time())))){
