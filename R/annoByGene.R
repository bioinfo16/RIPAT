...
#' 
#' @usage 
#' annoByGene(hits, ran_hits = NULL, mapTool = 'blast',
...
#'
#' blast_gene = annoByGene(hits = blast_obj, ran_hits = NULL, outFileName = 'blast_res')
#' 
#' @export
annoByGene = function(hits, ran_hits = NULL, mapTool = 'blast', organism = 'GRCh37', interval = 5000, range = c(-20000, 20000), includeUndecided = FALSE, outPath = getwd(), outFileName = paste0('RIPAT', round(unclass(Sys.time())))){
